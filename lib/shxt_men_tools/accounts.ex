defmodule ShxtMenTools.Accounts do
  @moduledoc """
  ...
  alias ShxtMenTools.Accounts.{User, UserToken, UserNotifier}
  ...
  See `ShxtMenTools.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `ShxtMenTools.Accounts.User.registration_changeset/3` for a list of supported options.
  ...
  See `ShxtMenTools.Accounts.User.password_changeset/3` for a list of supported options.
